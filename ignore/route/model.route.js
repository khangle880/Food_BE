...
const { modelValidation: validation } = require('../../validations');
const { modelController: controller } = require('../../controllers');
const { modelPermission: permission } = require('../../permissions');
